...
fun FavoritesScreen(
    ...
    Scaffold(topBar = {
        ...
        Surface(
            modifier = Modifier.padding(it).padding(5.dp).fillMaxWidth()
        ) {
            Column(
                ...
                LazyColumn {
                    items(list) { list ->
                        CityRow(list, navController = navController, favoriteViewModel)
                    }
                }
...
fun CityRow(
    ...
    Surface(
        Modifier.padding(3.dp).fillMaxWidth().height(50.dp).clickable {
